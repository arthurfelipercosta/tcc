...
\end{itemize}
O processo de interação e os resultados visuais gerados por esta interface foram detalhados e ilustrados na seção sobre o desenvolvimento da interface web (Capítulo 4).
...
\end{itemize}
Exemplos de interação real com o bot foram apresentados na seção sobre o assistente conversacional (Capítulo 4).
