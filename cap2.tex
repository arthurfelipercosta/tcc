...
No contexto do sistema desenvolvido, a API em Python\cite{PYTHON} serve como um ponto de acesso central aos dados veiculares processados, permitindo que \textbf{tanto a interface web quanto o N8N possam solicitar informações} de forma padronizada.
