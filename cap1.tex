...
Para alcançar esse objetivo, foram definidas várias etapas específicas:
\begin{itemize}
    ...
    \item Integrar o sistema com a plataforma N8N para orquestrar o fluxo automatizado.
    \item Configurar o envio e recebimento de mensagens via Twilio no WhatsApp.
    \item Aplicar inteligência artificial por meio da API da OpenAI para aprimorar a análise.
\end{itemize}

\section{Contribuições do trabalho}
A justificativa para este projeto está na crescente demanda por soluções que tornem a interação humana com dados estruturados mais eficiente, acessível e rápida. Ao automatizar a consulta e comparação de veículos, o {n8n\_bot.py} demonstra ser uma ferramenta prática e robusta, capaz de economizar tempo, aprimorar a qualidade das informações obtidas e apoiar as decisões fundamentadas em um contexto real de inovação tecnológica.

\section{Estrutura da Monografia}
Este trabalho está organizado nos seguintes capítulos:
\begin{itemize}
    \item Capítulo 2: "Fundamentação Teórica", apresenta os conceitos e tecnologias em que se baseia a solução encontrada.
    \item Capítulo 3: "Metodologia", aqui são descritas as etapas e ferramentas utilizadas na construção do trabalho.
    ...
    \item Capítulo 6: "Conclusão", são retomados os objetivos, as principais contribuições são resumidas, e são discutidas as limitações encontradas, além de sugestões para trablahos futuros.
\end{itemize}
\vspace{1em}