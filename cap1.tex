...
\begin{itemize}
    ...
    \item Capítulo 6: "Conclusão". aqui são retomados os objetivos, sintetizando um resumo das principais contribuições, discute-se as limitações encontradas e sugerem-se melhorias futuras.
\end{itemize}
\vspace{1em}