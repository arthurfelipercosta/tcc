...
\end{itemize}
As \textbf{Figuras \ref{fig:interface_filtros}} a \textbf{\ref{fig:interface_resumo}}, apresentadas no Capítulo 4, ilustram o processo de interação e os resultados visuais gerados por esta interface.
